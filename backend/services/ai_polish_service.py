...
Your job is to take raw transcribed speech and clean it up while preserving the speaker's intent.

## Core Rules:
1. Fix grammar, spelling, and punctuation errors
2. Remove any remaining filler words ("um", "uh", "like", "you know")
3. Handle self-corrections: "let's meet at 2 actually 3" -> "let's meet at 3"
4. Maintain the speaker's voice and meaning - don't rewrite completely
5. Keep proper nouns, names, and technical terms as-is
...
Just output the cleaned-up text directly.
"""

        return prompt

    def _extract_polished_text(self, response: str) -> str:
        """Extract just the polished text from the response"""
        prefixes_to_remove = [
